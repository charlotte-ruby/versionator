...
TODO: Currently there is no error checking in place for each of these automated steps.  The rake tasks should be changed to stop execution if their is code to be committed or new code from the pull
